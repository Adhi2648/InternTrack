        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <label className="flex flex-col">
              ...
              <input
                className="mt-1 rounded border border-input bg-background text-foreground px-3 py-2 focus:outline-none focus:ring-2 focus:ring-ring placeholder:text-muted-foreground"
                value={username}
            ...
            <label className="flex flex-col">
              <span className="text-sm text-foreground">Confirm Password</span>
              <input
                type="password"
                className="mt-1 rounded border border-input bg-background text-foreground px-3 py-2 focus:outline-none focus:ring-2 focus:ring-ring placeholder:text-muted-foreground"
